...
const VendorProfile = () => {
  ...
  const sidebarItems = [
    ...
    { 
      ...
      label: 'Cart', 
      path: '/vendor/cart', 
      active: location.pathname === '/vendor/cart',
      badge: cartTotals.totalItems > 0 ? cartTotals.totalItems : null
    },
    { icon: ShoppingBag, label: 'Orders', path: '/vendor/orders', active: location.pathname === '/vendor/orders' },
  ];

  const bottomItems = [
    { icon: Settings, label: 'Settings', path: '/vendor/settings', active: location.pathname === '/vendor/settings' },
          ...
          <div className="space-y-2">
            {sidebarItems.map((item) => (
              <button
                ...
                className={`w-full flex items-center gap-4 px-4 py-4 rounded-lg transition-colors relative ${
                  item.active
        ...
        <div className="bg-white border-b border-secondary-200 px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-secondary-600 mt-1">Manage your vendor account information</p>
            </div>
